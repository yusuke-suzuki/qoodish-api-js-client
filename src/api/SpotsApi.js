...
export default class SpotsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the mapsMapIdSpotsPlaceIdGet operation.
     * @callback module:api/SpotsApi~mapsMapIdSpotsPlaceIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SpotsApi~mapsMapIdSpotsPlaceIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Spot}
     */
    mapsMapIdSpotsPlaceIdGet(mapId, placeId, callback) {
      let postBody = null;
      // verify the required parameter 'mapId' is set
      if (mapId === undefined || mapId === null) {
        throw new Error("Missing the required parameter 'mapId' when calling mapsMapIdSpotsPlaceIdGet");
      }
      // verify the required parameter 'placeId' is set
      if (placeId === undefined || placeId === null) {
        throw new Error("Missing the required parameter 'placeId' when calling mapsMapIdSpotsPlaceIdGet");
      }
      ...
      let returnType = Spot;
      return this.apiClient.callApi(
        '/maps/{map_id}/spots/{place_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
