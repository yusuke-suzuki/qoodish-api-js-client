...
QoodishApiJsClient - JavaScript client for qoodish-api-js-client
Qoodih API. 
...
```shell
npm install qoodish-api-js-client --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your qoodish-api-js-client from, and run:
...
```javascript
var QoodishApiJsClient = require('qoodish-api-js-client');
